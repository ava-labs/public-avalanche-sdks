import { isExportTx, isImportTx, useLatestTeleporterTransactions } from '@/hooks/use-transactions';
            ...
            <Card className="border-0 rounded-none px-2 py-3 border-b-2 flex items-center">
              ...
              <div className="flex flex-col items-start ml-2">
                <div className="flex justify-center items-center">
                  ...
                  <span className="text-neutral-400 text-sm ml-1">{dayjs(tx.blockTimestamp * 1000).fromNow()}</span>
                </div>
                <Card
                  className={cn(
              ...
              <div className="flex grow items-center justify-end">
                <p className="text-xl">
                  ...
                  <span className="font-semibold text-sm text-neutral-400">{tx.erc20Token.symbol}</span>
                </p>
              </div>
            </Card>
          );
